    ...
    switch (type) {
      case "heading":
        ...
        return (
          <HeadingTag
            key={blockIndex}
            className={`font-bold text-gray-300 mb-3 mt-4 ${
      ...
      case "list":
        ...
        const listClass =
          format === "ordered"
            ? "list-decimal pl-5 mb-4 text-gray-300"
            : "list-disc pl-5 mb-4 text-gray-300";
        ...
        .then((response) => {
          ...
          if (lastSectionData) {
            const formattedLastSection = {
              ...
              title: lastSectionData.Title || null,
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16 px-4 md:px-0">
            <div className="w-full md:w-1/2 md:pr-4">
              {renderRichText(futureData.description)}
            </div>
