    ...
    return (
        <div className="w-full bg-gradient-to-r from-orange-200 to-orange-500 pt-32 pb-20 relative">
            ...
            <div className="relative z-10">
                <div
                    className="flex flex-col md:flex-row items-center justify-center md:space-x-3 w-full">
                ...
                <div className="flex justify-center mb-10">
                    <div
                        className="w-1/6  hidden md:block h-1.5 bg-gradient-to-r from-orange-500 to-red-500 rounded-full"></div>
                </div>
