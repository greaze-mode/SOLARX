...
export const EventSection = () => {
    ...
    const visibleProjects = eventData.slice(
        currentIndex,
    ...
    return (
        <div className="w-full px-[69px] py-12">
                    ...
                    {visibleProjects.map((project) => (
                        ...
                        >
                            <div className="relative h-56 sm:h-64 overflow-hidden">
                                {project.imgSrc ? (
                                    <img
                                        src={project.imgSrc[0].src}
                                        alt={project.imgSrc[0].alt}
            ...
            {selectedProject && (
                <div className="fixed inset-0 bg-black bg-opacity-75 z-[9999] flex items-start justify-center overflow-y-auto" style={{ paddingTop: "40px", paddingBottom: "40px" }}>
